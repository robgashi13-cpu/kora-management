        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md" onClick={onClose}>
            <div className="bg-[#1a1a1a] text-white w-full max-w-5xl h-[95vh] rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-white/10" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex-1 overflow-auto bg-[#525659] p-8 flex justify-center">
                    ...
                    <div
                        ref={printRef}
                        className="bg-white text-black w-full max-w-[21cm] min-h-[29.7cm] p-[2.5cm] shadow-2xl"
                                ...
                                <ol className="list-decimal ml-5 space-y-4 mb-8">
                                    <li>
                                        ...
                                        <ul className="list-[circle] ml-5 mt-1 text-sm">
                                            <li>Shuma totale prej {sale.soldPrice}€ do të transferohet në llogarinë bankare të RG SH.P.K.</li>
