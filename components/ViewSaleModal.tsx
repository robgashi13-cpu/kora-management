...
import { CarSale, Attachment, PaymentHistoryEntry, PaymentHistoryMethod } from '@/src/types';
...
const PaymentHistoryView = ({ history }: { history?: PaymentHistoryEntry[] }) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-2 text-slate-500 shrink-0">
                                ...
                                <span className="font-medium text-slate-600 truncate max-w-[140px]">{entry.changedBy}</span>
                            </div>
                        </li>
                    );
                })}
